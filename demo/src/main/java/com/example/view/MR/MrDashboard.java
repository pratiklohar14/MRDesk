...
public class MrDashboard {
    ...
    private void navigateToSection(String sectionName) {
        ...
        switch (sectionName) {
            case "Daily Schedule":
                pageContent = new MrDailySchedule().createPage();
                break;
            case "Doctors":
                pageContent = new MrDoctors().createPage();
                break;
            case "Hospitals / Clinics":
                pageContent = new MrClinics().createPage();
                break;
            case "Product Report":
            ...
            case "Reports":
                ...
                break;
            case "Settings":
                pageContent = new MrProfile().createPage();
                break;
            case "Dashboard":
            default:
