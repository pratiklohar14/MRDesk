...
public class SignUp {
        ...
        public Scene createView(Stage stage) {
                ...
                signUpBtn.setOnAction(e -> {
                        System.out.println(
                                        "Registration submitted for: " + fullNameField.getText() + " ("
                                                        + emailField.getText() + ")");
                        MrDashboard dashBoard = new MrDashboard();
                        Stage currentStage = (stage != null) ? stage : Welcome.welcomeStage;
                        if (currentStage == null && signUpBtn.getScene() != null) {
                                currentStage = (Stage) signUpBtn.getScene().getWindow();
                        }
                        Scene dashboardScene = dashBoard.createView(currentStage);
                ...
                loginBtn.setOnAction(event -> {
                        ...
                        Stage currentStage = (stage != null) ? stage : Welcome.welcomeStage;
                        if (currentStage == null && loginBtn.getScene() != null) {
                                currentStage = (Stage) loginBtn.getScene().getWindow();
                        }
                        Scene loginScene = loginPage.createView(currentStage);
                        if (currentStage != null) {
                ...
                double w = (primaryStage != null && primaryStage.getWidth() > 0) ? primaryStage.getWidth()
                                : (Welcome.welcomeStage != null && Welcome.welcomeStage.getWidth() > 0)
                                                ? Welcome.welcomeStage.getWidth()
                                                : 1360;
                double h = (primaryStage != null && primaryStage.getHeight() > 0) ? primaryStage.getHeight()
                                : (Welcome.welcomeStage != null && Welcome.welcomeStage.getHeight() > 0)
                                                ? Welcome.welcomeStage.getHeight()
                                                : 860;
                signUpScene = new Scene(root, w, h);
